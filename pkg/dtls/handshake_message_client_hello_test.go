...
func TestHandshakeMessageClientHello(t *testing.T) {
	rawClientHello := []byte{
		...
		/* random */
		0x42, 0x54, 0xff, 0x86, 0xe1, 0x24, 0x41, 0x91, 0x42, 0x62, 0x15, 0xad, 0x16, 0xc9, 0x15,
		0x8d, 0x95, 0x71, 0x8a, 0xbb, 0x22, 0xd7, 0x47, 0xec, 0xd8, 0x3d, 0xdc, 0x4b,

		/* cookie */
		0x00, 0x14, 0xe6, 0x14, 0x3a, 0x1b, 0x04, 0xea, 0x9e, 0x7a, 0x14,
		0xd6, 0x6c, 0x57, 0xd0, 0x0e, 0x32, 0x85, 0x76, 0x18, 0xde, 0xd8,

		/* cipher suites: ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 */
		0x00, 0x02, 0xc0, 0x2b,
		...
		/* cid ext */
		0x00, 0x34, 0x00, 0x04, 0x03, 0x03, 0x09, 0x04,
	}
	...
	parsedClientHello := &handshakeMessageClientHello{
		...
		extensions: []extension{
			...
			&extensionConnectionId{connectionId: []byte{0x03, 0x09, 0x04}},
		},
	}
